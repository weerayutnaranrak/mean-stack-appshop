...
export class HomeComponent implements OnInit {
  ...
  getproduct(){
    this.Http.get<any>('http://localhost:3000/getproductapi').subscribe(result=>{
  ...
  savebasget(){
    ...
    this.Http.post<any>("http://localhost:3000/addbasgetapi",this.basgetdata).subscribe(result=>{
